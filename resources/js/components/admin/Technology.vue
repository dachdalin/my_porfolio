    ...
    <AppLayout>
        <div class="container bg-gray-100 h-screen">
            <div class="flex items-center justify-between py-8">
                <h1 class="text-4xl font-bold text-gray-800">Technology</h1>
                ...
                <div class="bg-white rounded-lg shadow-xl w-full max-w-md">
                    <div class="p-6">
                        ...
                        <form @submit.prevent="submitForm">
                            ...
                            <div class="mb-4">
                                <div  v-if="form.tech.length && isEditing" class="flex flex-wrap gap-2">
                                    <span v-for="(tech, index) in formatTechTags(form.tech)" :key="index"
                                ...
                                <div v-else v-if="form.tech.length" class="flex flex-wrap gap-2">
