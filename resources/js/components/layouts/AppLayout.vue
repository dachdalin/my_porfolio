      ...
      <nav class="bg-gray-800 text-white p-4">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div class="hidden md:flex items-center space-x-4">
            ...
            <router-link to="/admin" class="text-white hover:text-gray-300">Dashboard</router-link>
          ...
          <div class="hidden md:flex items-center space-x-4">
            ...
            <button @click="toggleHelpMenu" class="text-white hover:text-gray-300 px-4 py-2 flex items-center gap-1 focus:outline-none">
              {{ authname }}
            ...
            <!-- Help Dropdown -->
            <div v-if="isHelpMenuOpen" class="absolute z-10 mt-2 w-48 origin-top rounded-md bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
              <div class="py-1">
